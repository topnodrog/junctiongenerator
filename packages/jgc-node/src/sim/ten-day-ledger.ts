 ...
 *
 * This deliberately does not mutate the live `jgtc-testnet-v2` rules. The
...
export function buildTenDayLedger(startTimestamp = TEN_DAY_START_UTC): TenDayLedgerResult {
  ...
  return {
    mode: "daily-distribution-prototype-v1",
    warning: "Valueless repeatable protocol prototype; not deployed to jgtc-testnet-v2 and not valid under its current immediate epoch-boundary settlement rule.",
