...
`auditRoot`; an early zero-premine JGTC public pilot is live, but no valuable
JGC mainnet is deployed. Positioned as a **store of value**. Codebase: `packages/jgc-node`. See
[[project-jgc]].
